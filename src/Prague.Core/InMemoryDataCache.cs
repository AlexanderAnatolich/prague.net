...
public sealed class InMemoryDataCache<TKey, TValue>
	...
	public CacheSymmetricKeyValueListIndex<TKey, TValue, TIndexKey> CacheSymmetricKeyValueListIndex<TIndexKey>(
		Func<TKey, TValue, TIndexKey> indexer, int expectedValuesPerKey = 0)
		where TIndexKey : notnull {
		var index = new CacheSymmetricKeyValueListIndex<TKey, TValue, TIndexKey>(indexer, expectedValuesPerKey);
		var len = _indeces.Length;
		Array.Resize(ref _indeces, len + 1);
		_indeces[len] = index;
		return index;
	...
	public CacheKeyValueListIndex<TKey, TValue, TIndexKey> CacheKeyValueListIndex<TIndexKey>(
		Func<TKey, TValue, TIndexKey> indexer, int expectedValuesPerKey = 0)
		where TIndexKey : notnull {
		var index = new CacheKeyValueListIndex<TKey, TValue, TIndexKey>(indexer, expectedValuesPerKey);
		var len = _indeces.Length;
		Array.Resize(ref _indeces, len + 1);
		_indeces[len] = index;
		return index;
	...
	public CacheKeyValueListIndex<TKey, TValue, TIndexKey> CacheCollectionKeyValueListIndex<TIndexKey>(
		Func<TKey, TValue, IReadOnlyList<TIndexKey>> collectionSelector, int expectedValuesPerKey = 0)
		where TIndexKey : notnull {
		var index = new CacheKeyValueListIndex<TKey, TValue, TIndexKey>(collectionSelector, expectedValuesPerKey);
		var len = _indeces.Length;
		Array.Resize(ref _indeces, len + 1);
		_indeces[len] = index;
		return index;
	...
	public CacheCollectionSymmetricKeyValueListIndex<TKey, TValue, TIndexKey> CacheCollectionSymmetricKeyValueListIndex<TIndexKey>(
		Func<TKey, TValue, IReadOnlyList<TIndexKey>> collectionSelector, int expectedValuesPerKey = 0)
		where TIndexKey : notnull {
		var index = new CacheCollectionSymmetricKeyValueListIndex<TKey, TValue, TIndexKey>(collectionSelector, expectedValuesPerKey);
		var len = _indeces.Length;
		Array.Resize(ref _indeces, len + 1);
		_indeces[len] = index;
		return index;
